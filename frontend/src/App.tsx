...
const LoginRequiredRoute:React.FC<LoginRequiredRouteProps> = ({ userIsActive, redirectPath = '/login'}, children) => {
  if (!userIsActive) {
  ...
  <>
   <AppBar component={'nav'}>
     <Toolbar>
       ...
       {!isActive ? (
          <Link to='/login'><Typography variant='body1'>Log In</Typography></Link>
         ) : (
